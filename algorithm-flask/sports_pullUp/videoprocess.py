...
def video_process(video_path='pullUps_sample.mp4'):
    # 指定视频路径和输出名称
    # video_path = 'pullUps_sample.mp4'
    ...
    out_video_path = 'pullUps_sample-out.mp4'
    ...
    # print("-------------------------")
    return repetitions_count, out_video_path